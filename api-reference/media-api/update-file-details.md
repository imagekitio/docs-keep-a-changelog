...
`AITags`
 ...
 and apply Extensions (<-hyperlink) using update file detail API. 
...
{% swagger-parameter in="body" name="removeAITags" type="array" %}
...
`AITags`
 ...
 associated with the file, send a string - 
...
{% swagger-parameter in="body" name="webhookUrl" type="string" %}
...
{% swagger-parameter in="body" name="customCoordinates" type="string" %}
