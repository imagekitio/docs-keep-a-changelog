...
7\. relevance - `ASC_RELEVANCE` or `DESC_RELEVANCE`
...
{% hint style="info" %}
The "Exact match" and "Begins with match" are case-sensitive while "Contains match" is case-insensitive.
{% endhint %}
...
{% tab title="Contains match" %}
To find a file or folder containing the search term, you can use `HAS` operator. For example:

```
name HAS "dress"
```

This will return `red-dress-summer.jpg`,`red-dress-winter.jpg` and `Red-Dress-Spring.jpg`.
{% endtab %}
{% endtabs %}
...
| ----------------------------------------------------------------------- | --------- | ---------------------- |
|<p>  name                                   </p>| <ul><li>=</li><li>:</li><li>IN</li><li>NOT =</li><li>NOT IN</li><li>HAS</li></ul>                                                                                                                 | <p>Accepts a string value in quotes. For example:</p><p><code>name = "red-dress.jpg" </code>will return all<br>files &#x26; folders with the exact name <code>red-dress.jpg</code>.</p><p><code>name: "red-dress"</code> will return all files &#x26; folders</p><p>with a name starting with <code>red-dress</code>.</p><p><code>name IN ["red-dress.jpg", "red-dress.png"]</code> will return</p><p>all files &#x26; folders with the name either <code>red-dress.jpg</code> or</p><p><code>red-dress.png</code>.</p><p><code>name NOT = "red-dress.jpg"</code> will return all files and folders</p><p>with a name other than <code>red-dress.jpg</code>.</p><p><code>name HAS "red"</code> will return all files and folders starting with the word <code>red</code> or containing the word <code>red</code>.</p>                                                                                                                                      |
...
|<p>  Custom metadata `Text` type field      </p>| <p></p><ul><li>=</li></ul><ul><li>:</li></ul><ul><li>IN</li></ul><ul><li>NOT =</li></ul><ul><li>NOT IN</li><li>HAS</li></ul>                                                                      | <p>Accepts a string value in quotes. For example:</p><p><code>"customMetadata.description" = "black cars" </code>will return all files &#x26; folders with the description custom field exactly equal to <code>black cars</code>.</p><p><code>"customMetadata.description": "red"</code> will return all files &#x26; folders with the description custom field starting with <code>red</code>.</p><p><code>"customMetadata.description" IN ["red cars", "black cars"]</code> will return all files &#x26; folders with the description custom field either <code>red cars</code> or</p><p><code>black cars</code>.</p><p><code>"customMetadata.description" NOT = "red dress"</code> will return all files and folders</p><p>with the description custom field other than <code>red dress</code>.</p><p><code>"customMetadata.description" HAS "red"</code> will return all files &#x26; folders with the description custom field starting with <code>red</code> or containing the word <code>red</code>.</p> |
|<p>  Custom metadata `Textarea` type field  </p>| <p></p><ul><li>=</li></ul><ul><li>:</li></ul><ul><li>IN</li></ul><ul><li>NOT =</li></ul><ul><li>NOT IN</li><li>HAS</li></ul>                                                                      | <p>Accepts a string value in quotes. For example:</p><p></p><p><code>"customMetadata.longDescription": "luxury"</code> will return all files &#x26; folders with the longDescription custom field starting with <code>luxury</code>.</p><p><code>"customMetadata.longDescription" HAS "luxury"</code> will return all files &#x26; folders with the longDescription custom field starting with <code>luxury</code> or containing the word <code>luxury</code>.</p>                                                                                                                                                                   |
