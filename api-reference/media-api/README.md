...
| bitRate           | Bitrate of the media file                                                                                                                                                                                                               |
| videoCodec        | Video codec of the first stream for the media file (Only for Video)                                                                                                                                                                                                  |
| audioCodec        | Primary audio codec for the media file (Only for Video)                                                                                                                                                                                                  |
| duration          | Duration of the media file content (Only for Video)                                                                                                                                                                                                      |
