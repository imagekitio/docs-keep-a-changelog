...
| <p><strong>checks</strong></p><p>optional</p>                  | Server-side checks to run on the asset. To know more about Upload API checks, [read this](../../features/upload-api-checks.md) |
