...
| height            | Height of the media file in pixels (Only for Images, Videos)                                                                                                                                                                            |
| width             | Width of the media file in pixels (Only for Images, Videos)                                                                                                                                                                             |
...
| duration          | Duration of the media file content (Only for Videos)                                                                                                                                                                                    |
