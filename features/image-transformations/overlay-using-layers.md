...
|------------------------------------|-------------------------------------------------------|---------------------------------|
| w                                  | [otw](./overlay#overlay-text-width---otw)             | Width of the whole text layer.  |
| fs                                 | [ots](./overlay#overlay-text-size---ots)              | Font size  |
| ff                                 | [otf](./overlay#overlay-text-font---otf)              | Font family |
| co                                 | [otc](./overlay#overlay-text-color---otc)             | Color  |
...
| pa                                 | [otp](./overlay#overlay-text-padding---otp)           | Padding |
| al                                 | [oa](./overlay#overlay-transparency---oa)             | Alpha |
| tg                                 | [ott](./overlay#overlay-text-typography---ott)        | Typography |
...
| [r](../image-transformations/resize-crop-and-other-transformations#radius-r)             | [otr](./overlay#overlay-radius---or)            | It is used to control the radius of the corner. To get a circle or oval shape, set the value to `max`. |
