...
| [fo](../image-transformations/resize-crop-and-other-transformations.md#focus-fo)                               | Relative focus area used during cropping. Accepts `face`, `custom`, `center`, `top`, `left`, `bottom`, `right`, `top_left`, `top_right`, `bottom_left`, and `bottom_right`. It also supports [object-aware cropping](../image-transformations/resize-crop-and-other-transformations.md#object-aware-cropping---fo-object-name). |
...
| [o](../image-transformations/resize-crop-and-other-transformations.md#opacity-o)                                | It is used to specify the opacity level of the output image. It accepts numerical values ranging from 0 to 100, where 0 would produce a completely transparent image, and 100 would have no effect. |
...
| [x](../image-transformations/resize-crop-and-other-transformations.md#examples-focus-using-cropped-image-coordinates)              | It is used along with [cm-extract](../image-transformations/resize-crop-and-other-transformations.md#extract-crop-strategy-cm-extract) to specify the `X` coordinate of the top-left point where the extract must begin. Possible values are integers, or an arithmetic expression such as `iw_div_2`, or `bh_sub_100`. Learn more about arithmetic expressions [here](../arithmetic-expressions-in-transformations.md).|
| [y](../image-transformations/resize-crop-and-other-transformations.md#examples-focus-using-cropped-image-coordinates)              | It is used along with [cm-extract](../image-transformations/resize-crop-and-other-transformations.md#extract-crop-strategy-cm-extract) to specify the `Y` coordinate of the top-left point where the extract must begin. Possible values are integers, or an arithmetic expression such as `ih_div_2`, or `bw_sub_150`. Learn more about arithmetic expressions [here](../arithmetic-expressions-in-transformations.md).|
| [xc](../image-transformations/resize-crop-and-other-transformations.md#examples-focus-using-cropped-image-coordinates)              | It is used along with [cm-extract](../image-transformations/resize-crop-and-other-transformations.md#extract-crop-strategy-cm-extract) to specify the `X` coordinate of the center point of the image to be extracted. Possible values are integers, or an arithmetic expression such as `iw_div_3`, or `ih_div_4`. Learn more about arithmetic expressions [here](../arithmetic-expressions-in-transformations.md).|
| [yc](../image-transformations/resize-crop-and-other-transformations.md#examples-focus-using-cropped-image-coordinates)              | It is used along with [cm-extract](../image-transformations/resize-crop-and-other-transformations.md#extract-crop-strategy-cm-extract) to specify the `Y` coordinate of the center point of the image to be extracted. Possible values are integers, or an arithmetic expression such as `iw_div_3`, or `ih_div_4`. Learn more about arithmetic expressions [here](../arithmetic-expressions-in-transformations.md).|
...
[pg](../image-transformations/resize-crop-and-other-transformations.md#page)| It is used to deliver a specified page, frame, or layer from a multi-page, multi-frame, or multi-layer file such as PSD, PDF, or GIF. If this parameter is not provided with a supported multi-page, multi-frame, or multi-layer overlay asset, the first page, layer, or frame is delivered by default. Learn more about this parameter and the list of supported multi-page, multi-frame, and multi-layer file formats [here](../image-transformations/resize-crop-and-other-transformations.md#page)|
